...
Als Referenz der zu enthaltenden Regeln dient die Parse--Grammatik des MPA (siehe Anhang TODO). Es wurden ähnliche Definitionen für Instaparse und Kern vorgenommen und sie produzieren zumindest für die Testformeln das gleiche Ergebnis. Diese Grammatiken werden im Folgenden \emph{volle Grammatiken} genannt.
...
Es ist festgestellt worden, dass die Grammatik gut konstruiert wurde und die enorm lange Parse--Zeit nicht von Unnötigkeiten in der Grammatik abhinge. Daher bemühte sich Mark Engelberg uns zu helfen, dem Problem auf den Grund zu gehen.

Das angenommene Beispiel waren die vollen Sudokuregeln. Diese sind mithilfe von insgesammt 168075 Zeichen (Character) beschrieben. Das reine Geschwindigkeit des Lesens wurde mit hilfe einer einfachen Grammatik geprüft.
